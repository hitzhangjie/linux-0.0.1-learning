 ...
 * 2015-04-11 04:51:49 PM
 * 
 * hard disk block-seek algorithm, includes following common:
 * 1) first come, first service
 * 2) shortest seek time first
 * 3) scan, i.e, elevator algorithm
 * 4) single direction scan
 * ...
 * if you're interested in these algorithms, you can reference wiki.
 */
...
void hd_init(void)
{
	...
	/**
	 * hit.zhangjie@gmail.com 
	 * 2015-04-11 04:54:59 PM
	 * 
	 * initialize the request buffer in hard disk
	 */
